...
fun NavigationDrawerContent(
    currentCharacterList: CharactersViewModel.CharactersListType,
            ...
            NavigationDrawerItem(
                ...
                onClick = {
                    when (navItem.charactersListType) {
                        CharactersViewModel.CharactersListType.CHARACTERS -> onEnterCharacters()
                        CharactersViewModel.CharactersListType.FAVORITES -> onEnterFavorites()
